      ...
      file =>
        new Promise((resolve, reject) => {
          ...
          let uploadTask = storage
            .child(`/images/receipe/${file.name}`)
            .put(file, metadata);
          uploadTask.on(
...
function Blogs(props) {
  ...
  function handleUpload(e) {
    ...
    const uploadTask = storage.ref(`/images/receipe/${time + "_" + file.name}`).put(file);
  ...
  const handleAddPostData = (e) => {
    ...
    if (postPositions.current.value.length === 0 || postTopics.current.value.length === 0) {
      ...
      if (editDetails) {
        ...
        firebase.database().ref(`receipe/${postId}`).set(
          {
          ...
          .then((response) => {
            alert("receipe edited succesfully");
      ...
      //  if user wants to add a new card
        ...
        firebase.database().ref('receipe/').push(
          {
  ...
  const handleDelete = (postId, e) => {
    if (window.confirm("Are you sure you want to delete the receipe?")) {
      // Axios
      // .delete(`https://educaretech-dashboard-default-rtdb.firebaseio.com/SessionData/${postId}.json`)
      firebase.database().ref(`receipe/${postId}`).remove()
        .then((response) => {
          alert("receipe deleted succesfully");
          window.location.reload();
          ...
          <div className="modal-dialog modal-lg" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">{editDetails ? "Edit receipe" : "Add receipe"}</h5>
              ...
              <div className="modal-body">
                <form onSubmit={handleUpload}>
                  ...
                  <div className="form-group">
                    <label for="topic">Receipe Name</label>
                  ...
                  <div className="form-row">
                    ...
                    {/* <div className="form-group col-md-6">
                      ...
                      <select id="status" className="form-control"
                        ...
                        <option selected>Select Events Status</option>
                        <option value="0">Past-Events</option>
            ...
            <div className="col-lg-11">
              ...
              <div className="add-teacher-profile pb-3">
                <div className="d-flex justify-content-between">
                  <div className="title">
                    <h2 id="teach_profile">Receipe</h2>

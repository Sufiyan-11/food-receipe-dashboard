...
//   const [postIsLink , setPostIsLink] = useState("");
  ...
  function handleUpload(e) {
    ...
    const uploadTask = storage.ref(`/images/news/${time + "_" + file.name}`).put(file);
  ...
  const handleAddPostData = (e) => {
    ...
    if (postPositions.current.value.length === 0 || postTopics.current.value.length === 0) {
      ...
      if (editDetails) {
        ...
        firebase.database().ref(`news/${postId}`).set(
          {
  ...
  const handleDelete = (postId, e) => {
    if (window.confirm("Are you sure you want to delete the news?")) {
      ...
      firebase.database().ref(`news/${postId}`).remove()
        .then((response) => {
          ...
          <div className="modal-dialog modal-lg" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">{editDetails ? "Edit news" : "Add news"}</h5>
              ...
              <div className="modal-body">
                <form onSubmit={handleUpload}>
                  ...
                  <div className="form-group">
                    <label for="topic">News Name</label>
            ...
            <div className="col-lg-11">
              ...
              <div className="add-teacher-profile pb-3">
                <div className="d-flex justify-content-between">
                  <div className="title">
                    <h2 id="teach_profile">NewsLetter</h2>
              ...
              <div className="form-row">
                <div className="form-group col-md-11">
                  <label for="inputEmail4">Search based on News Name</label>
                  <input type="text" className="form-control" placeholder="search news" id="search-input" />
                </div>
